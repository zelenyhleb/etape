 ...
 *******************************************************************************/
package ru.zelenyhleb.etape.ui.templates;
...
import ru.zelenyhleb.etape.core.base.Formatters;
import ru.zelenyhleb.etape.ui.Messages;
import ru.zelenyhleb.etape.ui.wizards.bundle.ConfigurationPage;
...
public final class BaseBundleTemplate extends AbstractTemplateSection {
	...
	public URL getTemplateLocation() {
		try {
			URL find = FileLocator.find(Platform.getBundle("ru.zelenyhleb.etape.templates"), new Path("base")); //$NON-NLS-1$ //$NON-NLS-2$
